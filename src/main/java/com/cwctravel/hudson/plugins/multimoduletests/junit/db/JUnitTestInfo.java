...
public class JUnitTestInfo {
	...
	public String toString() {
		return "JUnitTestInfo [status=" + status + ", index=" + index + ", id=" + id + ", startTime=" + startTime + ", duration=" + duration + ", projectName=" + projectName + ", buildId=" + buildId + ", buildNumber=" + buildNumber + ", moduleName=" + moduleName + ", packageName=" + packageName + ", className=" + className + ", caseName=" + caseName + "]";
	}
